...
of course, no payment has been sent out of it. The node maintains
...
What happens if a payment arrives in this wallet after it's deleted? Say,
...
is still in the network, in Jessica's wallet. It's not lost. It's just that Jeff's
...
arrive in it, right? Correct. If Jeff loses it, it's lost forever. Jessica's
