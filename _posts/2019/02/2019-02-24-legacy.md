...
information has to be synchronized at some point, there will
...
overwriting the one, which was previously made by the same person. But
...
_immutable_ and no node will allow anyone to touch it.
